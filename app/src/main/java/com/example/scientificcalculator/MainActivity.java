...
public class MainActivity extends AppCompatActivity {
    ...
    public void btnClick_row(View view) {
        sign = "row";
        value1 = input.getText().toString();
        input.setText(null);
        hasDot = false;
    ...
    @SuppressLint("SetTextI18n")
    public void btnClick_egal(View view) {
        if (sign == null) {
    ...
    public void btnClick_supp(View view) {
        if (input.getText().equals("")) {
            input.setText(null);
        } else {
